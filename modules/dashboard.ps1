function Show-TNUtilityDashboard {
    ...
    $tabOptimize.Text = 'Windows Optimize'
    ...
    $planBox.Size = New-Object System.Drawing.Size(790, 300)
    ...
    $btnOptimize.Location = New-Object System.Drawing.Point(30, 400)
    ...
    $btnBalanced.Location = New-Object System.Drawing.Point(230, 400)
    ...
    $excludeGroup.Size = New-Object System.Drawing.Size(790, 180)
    ...
    $getExcluded = {
        ...
        foreach ($name in $checks.Keys) {
            if ($checks[$name].Checked) { $selected += $name }
        }
        return $selected
    }
